                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-4">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="callout callout-info">
                                                        ...
                                                        <br>
                                                        <strong class="h4">$<?php echo $info['SALESNO']; ?></strong>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="callout callout-danger">
                                                        ...
                                                        <br>
                                                        <strong class="h4"><?php echo $info['RETURN']; ?> items</strong>
                                                        <div class="chart-wrapper">
                                            ...
                                            <ul class="horizontal-bars">
                                                <?php
                                                    $storeName = "store_data_$city";
                                                    $query = "SELECT SALES AS SALES, RETURN_ITEMS AS RETURN_ITEMS FROM $storeName";
                                                    $day = 0;
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="callout callout-warning">
                                                        ...
                                                        <br>
                                                        <strong class="h4"><?php echo rand(2000, 5000); ?></strong>
                                                        <div class="chart-wrapper">
                                            ...
                                            <ul class="horizontal-bars type-2">
                                                <li>
                                                    ...
                                                    <span class="value"><?php echo $male_pct = rand(1, 100); ?>%</span>
                                                    <div class="bars">
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo $male_pct?>%" aria-valuenow="<?php echo $male_pct ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <span class="value"><?php echo 100-$male_pct ?>%</span>
                                                    <div class="bars">
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo 100-$male_pct ?>%" aria-valuenow="<?php echo 100-$male_pct ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="divider"></li>
