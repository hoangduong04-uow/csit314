...
<?php 
	...
	$totalQuantities=$allInfo['melbourne']['TOTALQUANTITIES'];
	$precent=($allInfo['melbourne']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"melbourne");
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"melbourne",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"melbourne",3000,9999999);?>]
    }]
});
	</script>
