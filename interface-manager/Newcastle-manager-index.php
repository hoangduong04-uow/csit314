...
<?php
	...
	$quantities=calTotalSalesNo($conn, "newcastle");
	$topSales=getTopItemBySaleCount($conn,"newcastle");
	$lowSales=getLowItemBySaleCount($conn,"newcastle");
 ?>


<?php $salesNoDay= calStoreSaleDay($conn, "newcastle");?>
<?php $returnNoDay= calStoreReturnDay($conn, "store_data_newcastle");?>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-primary">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allInfo['newcastle']['SALESNO']) ?></h4>
                                    <p>Number of sales</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-info">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allInfo['newcastle']['RETURN']) ?></h4>
                                    <p>Item Returns</p>
                                </div>
                                <div class="chart-wrapper px-1" style="height:70px;">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-warning">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allStatistics['managerStatNewcastle']['CUSTOMERNO']) ?></h4>
                                    <p>Customers</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-danger">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0">$<?php print_r($allInfo['newcastle']['TOTAL EXPENSE']) ?></h4>
                                    <p>Total Expenses</p>
                                </div>
                                <div class="chart-wrapper px-1" style="height:70px;">
