...
<?php
	...
	$itemsInfo= getAllInfo($conn,"melbourne");
	$storesInfo= getAllInfo($conn,"store_data_melbourne");
?>
        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
					...
					<li class="nav-item nav-dropdown">
                        <a class="nav-link" href="Melbourne-manager-strategy.php"><i class="icon-star"></i> Strategic Planning</a>
                    </li>
                    <li class="divider"></li>
                ...
                <div class="animated fadeIn">
                                ...
                                <div class="card-block">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Dexter Halbert</td>
                                                
                                                <td>Staff</td>
                                               
                                            </tr>
                                            <tr>
                                                <td>Crispin Dudley</td>
					...
					<div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> melbourne Store
                                </div>
                                <div class="card-block">
                                    <table class="table table-bordered table-striped table-condensed">
                                        <thead>
