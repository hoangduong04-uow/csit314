     ...
     <div class="app-body">
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="Adelaide-manager-index.php"><i class="icon-star"></i> Summary </a>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link" href="Adelaide-manager-records.php"><i class="icon-star"></i> Store operations </a>
                    </li>
                    <li class="nav-item">
