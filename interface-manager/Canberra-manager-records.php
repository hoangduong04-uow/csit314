...
<?php
	...
	$itemsInfo= getAllInfo($conn,"canberra");
	$storesInfo= getAllInfo($conn,"store_data_canberra");
?>
                ...
                <div class="animated fadeIn">
                                ...
                                <div class="card-block">
                                    <table class="table">
                                        ...
                                        <tbody>
											...
											<tr>
                                                <td>Quenby Fitzgerald</td>
                                              
                                                <td>Staff</td>
                                                
                                            </tr>
											<tr>
                                                <td>Emerson Lambert</td>
                                              
                                                <td>Staff</td>
                                                
                                            </tr>
											<tr>
                                                <td>Chapman Coleman</td>
					...
					<div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> canberra Store
                                </div>
                                <div class="card-block">
                                    <table class="table table-bordered table-striped table-condensed">
                                        <thead>
