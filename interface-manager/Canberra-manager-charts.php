...
<?php 
	...
	$totalQuantities=$allInfo['canberra']['TOTALQUANTITIES'];
	$precent=($allInfo['canberra']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"canberra");
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="hidden-md-down">canberra Manager</span>
                </a>
    ...
    <div class="app-body">
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Canberra-manager-index.php"><i class="icon-puzzle"></i> Summary</a>
                        <ul class="nav-dropdown-items">
                          
                        </ul>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Canberra-manager-records.php"><i class="icon-star"></i> Store operations</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
					...
					<li class="nav-item">
                        <a class="nav-link" href="Canberra-manager-strategy.php"><i class="icon-pie-chart"></i> Strategic Planning</a>
                    </li>
                    <li class="divider"></li>
                    <li class="nav-item nav-dropdown">
                        <ul class="nav-dropdown-items">
        ...
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="canberra-manager-index.html">Manager</a>
                </li>
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"canberra",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"canberra",3000,9999999);?>]
    }]
});
	</script>
