     ...
     <div class="app-body">
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="Centralcoast-manager-index.php"><i class="icon-star"></i> Summary </a>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link" href="Centralcoast-manager-records.php"><i class="icon-star"></i> Store operations </a>
                    </li>
                    <li class="nav-item">
