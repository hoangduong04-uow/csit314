...
<?php 
	...
	$totalQuantities=$allInfo['cairns']['TOTALQUANTITIES'];
	$precent=($allInfo['cairns']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"cairns");
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
						...
						<li class="nav-item">
                        <a class="nav-link" href="Cairns-manager-strategy.php"><i class="icon-pie-chart"></i> Strategic Planning</a>
                    </li>
                    <li class="divider"></li>
                    <li class="nav-item nav-dropdown">
                        <ul class="nav-dropdown-items">
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"cairns",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"cairns",3000,9999999);?>]
    }]
});
	</script>
