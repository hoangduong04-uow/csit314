...
<?php 
	...
	$totalQuantities=$allInfo['shellharbour']['TOTALQUANTITIES'];
	$precent=($allInfo['shellharbour']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"shellharbour");
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"shellharbour",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"shellharbour",3000,9999999);?>]
    }]
});
	</script>
