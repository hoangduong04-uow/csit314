...
<?php 
	...
	$totalQuantities=$allInfo['adelaide']['TOTALQUANTITIES'];
	$precent=($allInfo['adelaide']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"adelaide");
    ...
    <div class="app-body">
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Adelaide-manager-index.php"><i class="icon-puzzle"></i> Summary</a>
                        <ul class="nav-dropdown-items">
                          
                        </ul>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Adelaide-manager-records.php"><i class="icon-star"></i> Store operations</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
					...
					<li class="nav-item">
                        <a class="nav-link" href="Adelaide-manager-strategy.php"><i class="icon-pie-chart"></i> Strategic Planning</a>
                    </li>
                    <li class="divider"></li>
                    <li class="nav-item nav-dropdown">
                        <ul class="nav-dropdown-items">
        ...
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="Adelaide-manager-index.html">Manager</a>
                </li>
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"adelaide",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"adelaide",3000,9999999);?>]
    }]
});
	</script>
