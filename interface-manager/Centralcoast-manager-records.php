...
<?php
	...
	$itemsInfo= getAllInfo($conn,"centralcoast");
	$storesInfo= getAllInfo($conn,"store_data_centralcoast");
?>
        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
					...
					<li class="nav-item nav-dropdown">
                        <a class="nav-link" href="Centralcoast-manager-strategy.php"><i class="icon-star"></i> Strategic Planning</a>
                    </li>
                    <li class="divider"></li>
                ...
                <div class="animated fadeIn">
					...
					<div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> centralcoast Store
                                </div>
                                <div class="card-block">
                                    <table class="table table-bordered table-striped table-condensed">
                                        <thead>
