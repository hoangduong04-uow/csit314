...
<?php $salesNoDay= calStoreSaleDay($conn, "melbourne");?>
<?php $returnNoDay= calStoreReturnDay($conn, "store_data_melbourne");?>
    ...
    <div class="app-body">
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Melbourne-manager-index.php"><i class="icon-puzzle"></i> Summary</a>
                        <ul class="nav-dropdown-items">
                        </ul>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Melbourne-manager-records.php"><i class="icon-star"></i> Store operations</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
        ...
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="melbourne-manager-index.html">Manager</a>
                </li>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-primary">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allInfo['melbourne']['SALESNO']) ?></h4>
                                    <p>Number of sales</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-info">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allInfo['melbourne']['RETURN']) ?></h4>
                                    <p>Item Returns</p>
                                </div>
                                <div class="chart-wrapper px-1" style="height:70px;">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-warning">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allStatistics['managerStatMelbourne']['CUSTOMERNO']) ?></h4>
                                    <p>Customers</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-danger">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0">$<?php print_r($allInfo['melbourne']['TOTAL EXPENSE']) ?></h4>
                                    <p>Total Expenses</p>
                                </div>
                                <div class="chart-wrapper px-1" style="height:70px;">
