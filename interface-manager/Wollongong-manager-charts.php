...
<?php 
	...
	$totalQuantities=$allInfo['wollongong']['TOTALQUANTITIES'];
	$precent=($allInfo['wollongong']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"wollongong");
    ...
    <div class="app-body">
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Wollongong-manager-index.php"><i class="icon-puzzle"></i> Summary</a>
                        <ul class="nav-dropdown-items">
                          
                        </ul>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="Wollongong-manager-records.php"><i class="icon-star"></i> Store operations</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
        ...
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="Wollongong-manager-index.html">Manager</a>
                </li>
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"wollongong",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"wollongong",3000,9999999);?>]
    }]
});
	</script>
