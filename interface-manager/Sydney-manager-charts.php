...
<?php 
	...
	$totalQuantities=$allInfo['sydney']['TOTALQUANTITIES'];
	$precent=($allInfo['sydney']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"sydney");
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"sydney",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"sydney",3000,9999999);?>]
    }]
});
	</script>
