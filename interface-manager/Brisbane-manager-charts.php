...
<?php 
	...
	$totalQuantities=$allInfo['brisbane']['TOTALQUANTITIES'];
	$precent=($allInfo['brisbane']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"brisbane");
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"brisbane",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"brisbane",3000,9999999);?>]
    }]
});
	</script>
