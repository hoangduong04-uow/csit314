...
<?php
	...
	$itemsInfo= getAllInfo($conn,"wollongong");
	$storesInfo= getAllInfo($conn,"store_data_wollongong");
?>
                ...
                <div class="animated fadeIn">
                                ...
                                <div class="card-block">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Darell Chadwick</td>
                                                
                                                <td>Staff</td>
                                                
                                            </tr>
                                            <tr>
                                                <td>Halbert Irving</td>
					...
					<div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Wollongong Store
                                </div>
                                <div class="card-block">
                                    <table class="table table-bordered table-striped table-condensed">
                                        <thead>
