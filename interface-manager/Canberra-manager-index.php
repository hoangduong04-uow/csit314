...
<?php
	...
	$quantities=calTotalSalesNo($conn, "canberra");
	$topSales=getTopItemBySaleCount($conn,"canberra");
	$lowSales=getLowItemBySaleCount($conn,"canberra");
 ?>


<?php $salesNoDay= calStoreSaleDay($conn, "canberra");?>
<?php $returnNoDay= calStoreReturnDay($conn, "store_data_canberra");?>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-primary">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allInfo['canberra']['SALESNO']) ?></h4>
                                    <p>Number of sales</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-info">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allInfo['canberra']['RETURN']) ?></h4>
                                    <p>Item Returns</p>
                                </div>
                                <div class="chart-wrapper px-1" style="height:70px;">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-warning">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0"><?php print_r($allStatistics['managerStatCanberra']['CUSTOMERNO']) ?></h4>
                                    <p>Customers</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-danger">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0">$<?php print_r($allInfo['canberra']['TOTAL EXPENSE']) ?></h4>
                                    <p>Total Expenses</p>
                                </div>
                                <div class="chart-wrapper px-1" style="height:70px;">
