     ...
     <div class="app-body">
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index.html"><i class="icon-speedometer"></i> Summary </a>
                    </li>
                    

                   
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="components-tables.html"><i class="icon-puzzle"></i> Items</a>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-star"></i> Stores</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="widgets.html"><i class="icon-calculator"></i> Employee  </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-info">
                                <div class="card-block pb-0">
                                    ...
                                    <h4 class="mb-0">missing return counts</h4>
                                    <p>Return items</p>
                                </div>
                                <div class="chart-wrapper px-1" style="height:70px;">
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-5">
                                    ...
                                    <div class="small text-muted">April 2017</div>
                                </div>
                                <!--/.col-->
