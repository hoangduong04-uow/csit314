...
<?php 
	...
	$totalQuantities=$allInfo['centralcoast']['TOTALQUANTITIES'];
	$precent=($allInfo['centralcoast']['SALESNO']/$totalQuantities)*100;
	$TopProfitItems=getTopProfitItem($conn,"centralcoast");
...
Highcharts.chart('container3', {
    ...
    series: [{
        name: 'Count',
        data: [<?php echo calSaleNoByPrice($conn,"centralcoast",100,300);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",300,500);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",500,700);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",700,900);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",900,1100);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",1100,1500);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",1500,2000);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",2000,3000);?>, 
		<?php echo calSaleNoByPrice($conn,"centralcoast",3000,9999999);?>]
    }]
});
	</script>
